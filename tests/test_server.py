...
class TestMCPToolsIntegration:
    ...
    def test_get_class_source_integration(self, mock_interop_get_class_source):
        ...
        mock_interop_get_class_source.return_value = {"success": True, "result": "class source"}
    ...
    def test_list_packages_integration(self, mock_interop_list_packages):
        ...
        mock_interop_list_packages.return_value = {"success": True, "result": ["Package1", "Package2"]}
